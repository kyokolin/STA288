...
island_data %>%
  summarise(median=median(day_0_resp), min=min(day_0_resp), max=max(day_0_resp), Q1=quantile((day_0_resp),0.25), Q3=quantile((day_0_resp),0.75), IQR=Q3-Q1)
```
...
island_data %>%
  summarise(median=median(day_14_resp), min=min(day_14_resp), max=max(day_14_resp), Q1=quantile((day_14_resp),0.25), Q3=quantile((day_14_resp),0.75), IQR=Q3-Q1)
```
